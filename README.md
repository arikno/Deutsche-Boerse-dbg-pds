...
The Deutsche Börse Public Dataset is actually comprised of two sets of datas, representing source data from the XETRA and EUREX trading engines. The contents of this data are defined in the [data dictionary in the docs section](docs/data_dictionary.md).
